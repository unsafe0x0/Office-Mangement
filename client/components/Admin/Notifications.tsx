    ...
    return (
        <div className='flex flex-col justify-start items-start w-full h-full space-y-5'>
            <div className='flex justify-between items-center mb-4 w-full'>
                <div>
                    <h2 className='text-3xl font-semibold text-neutral-100 font-heading mb-2'>All Notifications</h2>
            ...
            <div className="bg-neutral-800/50 border border-neutral-700/50 rounded-md p-6 w-full">
                ...
                {filteredNotifications.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-normal text-neutral-300 mb-2">No notifications found</h3>
