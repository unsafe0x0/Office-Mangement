...
const EditLeaveForm: React.FC<EditLeaveFormProps> = ({ isOpen, onClose, leave, employee }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-neutral-900 rounded-md p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold text-neutral-100">Edit Leave Request</h2>
                </div>
                ...
                <div className="bg-neutral-800/50 border border-neutral-700 rounded-md p-4 mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <h3 className="text-lg font-semibold text-neutral-100">{employee.name}</h3>
                            <p className="text-neutral-400 text-sm">{employee.email}</p>
                            <div className="flex gap-4 mt-1">
                                <span className="text-neutral-300 text-sm">{employee.position}</span>
                                <span className="text-neutral-300 text-sm">{employee.department}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 pt-4">
                        ...
                        >
                            {updateLeaveMutation.isPending ? "Updating Leave..." : "Update Leave"}
                        </Button>
                        <RedButton
                            type="button"
                            onClick={handleClose}
