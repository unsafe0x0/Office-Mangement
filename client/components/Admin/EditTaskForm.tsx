                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {statusOptions.map((option) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                type="button"
                                                onClick={() => {
                                                    handleInputChange("status", option.value as TaskFormData["status"]);
                                                    setIsStatusDropdownOpen(false);
                                                }}
                    ...
                    <div>
                        ...
                        {formData.employeeIds.length > 0 && (
                            <div className="mt-3">
                                <p className="text-sm text-neutral-400 mb-2">Selected employees:</p>
                                <div className="flex flex-wrap gap-2">
                                    {formData.employeeIds.map((id, index) => (
                                        ...
                                        >
                                            {employees.find(emp => emp.id === id)?.name || "Unknown Employee"}
                                        </span>
                                    ))}
                                </div>
                            </div>
