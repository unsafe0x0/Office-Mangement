...
const NotificationCard = ({
    ...
    const [isEditNotificationFormOpen, setIsEditNotificationFormOpen] = useState(false);
        ...
        <div className="relative bg-neutral-800/50 border border-neutral-700 rounded-md p-6 hover:bg-neutral-800/70 transition-colors">
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-normal text-neutral-200">Notification</h3>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <span className={`px-2 py-1 rounded-md text-sm font-normal border ${getTargetBadgeStyle(forWhom)} flex items-center gap-1`}>
