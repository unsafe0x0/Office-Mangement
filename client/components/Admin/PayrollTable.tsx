...
const PayrollTable = ({ title, payrolls, employees }: PayrollTableProps) => {
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-neutral-400 text-sm">
                {payrolls.length} payroll record
                {payrolls.length !== 1 ? "s" : ""}
              </p>
            </div>
            ...
            <tbody>
              {payrolls.map((payroll, index) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-md overflow-hidden border border-neutral-600">
                        <img
                          ...
                          alt={payroll.employee?.name || payroll.employeeEmail}
                  ...
                  <td className="px-6 py-4 text-green-400 font-normal">
                    +{formatCurrency(payroll.bonus)}
                  </td>
                  <td className="px-6 py-4 text-red-400 font-normal">
                    -{formatCurrency(payroll.deductions)}
                  </td>
                  <td className="px-6 py-4 text-neutral-100 font-semibold">
